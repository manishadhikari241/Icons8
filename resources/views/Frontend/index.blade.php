    ...
    <div class="app-tabs">
        ...
        <div class="app-tabs-content">
            <div class="app-slider">
                <div class="images is-material" >
                    ...
                    <img src="https://img.icons8.com/material/4ac144/256/download-from-cloud.png" alt="download-from-cloud" >
                    </a>
        ...
        <div class="container">
            <div class="icons-grid row">
                <div data-wow="slide-left" data-wow-delay="100" class="icons-col  col-lg-3 col-md-3 col-sm-6" style="transition-delay: 100ms;">
                    <div class="icons-col-title">Single Style</div>
                    <div class="icons-col-text">All icons are done by a single team, so your work will look consistent.</div>
                </div>
                <div data-wow="slide-left" data-wow-delay="300" class="icons-col  col-lg-3 col-md-3 col-sm-6" style="transition-delay: 300ms;">
                ...
                <div data-wow="slide-left" data-wow-delay="500" class="icons-col  col-lg-3 col-md-3 col-sm-6" style="transition-delay: 500ms;">
                ...
                <div data-wow="slide-left" data-wow-delay="700" class="icons-col  col-lg-3 col-md-3 col-sm-6" style="transition-delay: 700ms;">
...
<section class="banners">
    <div class="banners-wrap">
        <a href="" class="banners-item is-wide is-photo-creator" style="background: linear-gradient(rgb(231, 157, 167), rgb(213, 133, 144));"></a>
        <a href="" class="banners-item is-stratos" style="    background-image: linear-gradient(225deg,#00001c,#00004c);"></a>
        <a href="" class="banners-item is-cherry" style="    background-image: linear-gradient(45deg,#ff5c4c,#cd23a4 49.4%,#7e46fb);"></a>
