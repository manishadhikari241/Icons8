                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Name" name="name" type="text" value="{{$style->name}}">
                            </div>

                            <div class="form-group mb-none">
                                <select name="parent_id" id="parent" class="form-control select2">
                                    @foreach($parent as $value)
                                        <option @if($style->parent_id==$value->id)selected @endif value="{{$value->id}}">{{$value->name}}</option>
