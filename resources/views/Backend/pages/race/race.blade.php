    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('voyager.races')}}"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group ">
                                                <label for="name" class="control-label">Race Name *</label>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Race Lists</h5>
                        ...
                        <table id="user" class="table table-bordered table-sm">
                            ...
                            @foreach($race as $key => $value)
                                <tr>
                                    ...
                                    <td>{{$value->name}}</td>
                                    <td>
                                        <a href="{{route('voyager.race-delete',$value->id)}}"
                                           onclick="return confirm('Confirm Delete?')"
                                           class="btn btn-sm btn btn-danger"><i class="fa fa-trash"></i> </a>
                                        <a href="{{route('voyager.race-edit',$value->id)}}" data-toggle="modal"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" align="center"><b>Edit Race</b></h4>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form method="POST" action="{{route('voyager.race-edit')}}"
                                                      accept-charset="UTF-8" class=""
                                                      enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="box box-default">
                                                        <div class="box-body">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <div class="form-group ">
                                                                        <label for="name" class="control-label">Race
                                                                            *</label>
