                                    ...
                                    <div class="form-group mb-none">
                                        <select class="form-control" name="artist">
                                            ...
                                            @foreach($artist as $value)
                                                <option @if($value->name==$music->artists->name)  selected
                                    ...
                                    <div class="form-group mb-none">
                                        <select class="form-control" name="tag[]" id="tags"
                                            ...
                                            @foreach($tag as $value)
                                                <option @if($music->tags()->where('tag_id',$value->id)->where('music_id',$music->id)->first())  selected
                                                        @endif value="{{$value->id}}">{{$value->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-none">
                                        <select class="form-control" name="themes[]" id="trends"
                                            ...
                                            @foreach($theme as $value)
                                                <option @if($music->themes()->where('theme_id',$value->id)->where('music_id',$music->id)->first()) selected
                                                        @endif value="{{$value->id}}">{{$value->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-none">
                                        <select class="form-control" name="genres[]" id="categories"
                                            ...
                                            @foreach($genre as $value)
                                                <option @if($music->genres()->where('genre_id',$value->id)->where('music_id',$music->id)->first())selected @endif
                                    ...
                                    <div class="form-group mb-none">
                                        <select class="form-control" name="moods[]" id="styles"
                                            ...
                                            @foreach($mood as $value)
                                                <option @if($music->moods()->where('mood_id',$value->id)->where('music_id',$music->id)->first())selected @endif
                                                value="{{$value->id}}">{{$value->name}}</option>
                                            @endforeach
                                        </select>
